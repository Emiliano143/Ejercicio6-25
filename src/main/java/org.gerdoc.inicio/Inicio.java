        ...
        while( flag )
        {
            ...
            switch( opcion )
            {
                ...
                case 4://Emiliano consola
                   ejecutable  = org.gerdoc.org.mendez.galindo.emiliano.vista.Consola.getInstance();
                    break;
                case 5://Ventana Emiliano
                    ejecutable  = org.gerdoc.org.mendez.galindo.emiliano.vista.Ventana.getInstance();
                    break;
                case 6://Willy consola
                    ejecutable  =  org.gerdoc.org.millan.escorza.william.andrey.vista.Consola.getInstance();
                    break;
                case 7://Ventana willy
                    ejecutable  =  org.gerdoc.org.millan.escorza.william.andrey.vista.Ventana.getInstance();
                case 8://Salir
                    flag = false;
                    break;
                default:
